...
class App extends Component {
  ...
  rentMovie = (id) =>{
    ...
    let rentedMovie = moviesCopy.find(m=>m.id===id)
  ...
  render() {
    ...
    return (
      ...
      <Router>
          ...
          rentMovie={this.rentMovie} unRentMovie={this.unRentMovie} />} />
